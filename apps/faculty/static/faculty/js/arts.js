/**
 * ============================================================
 * لوحة قسم الفنون التطبيقية - Arts Department Dashboard
 * arts.js  v2.0.0
 * ============================================================
 */

console.log('✅ arts.js v2.0.0 loaded');
...
function saveDeptHead() {
    localStorage.setItem('deptHead_arts', JSON.stringify({
...
function loadDeptHead() {
    const saved = localStorage.getItem('deptHead_arts');
    if (saved) {
...
function saveAll() {
    localStorage.setItem('deptTeachers_arts', JSON.stringify(teachers));
    localStorage.setItem('deptEmployees_arts', JSON.stringify(employees));
    saveDeptHead();
}

function loadAll() {
    const savedTeachers = localStorage.getItem('deptTeachers_arts');
    const savedEmployees = localStorage.getItem('deptEmployees_arts');
