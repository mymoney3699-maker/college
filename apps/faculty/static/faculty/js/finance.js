/**
 * ============================================================
 * لوحة قسم التمويل والاستثمار - Finance Department Dashboard
 * finance.js  v2.0.0
 * ============================================================
 */

console.log('✅ finance.js v2.0.0 loaded');
...
function saveDeptHead() {
    localStorage.setItem('deptHead_finance', JSON.stringify({
...
function loadDeptHead() {
    const saved = localStorage.getItem('deptHead_finance');
    if (saved) {
...
function saveAll() {
    localStorage.setItem('deptTeachers_finance', JSON.stringify(teachers));
    localStorage.setItem('deptEmployees_finance', JSON.stringify(employees));
    saveDeptHead();
}

function loadAll() {
    const savedTeachers = localStorage.getItem('deptTeachers_finance');
    const savedEmployees = localStorage.getItem('deptEmployees_finance');
