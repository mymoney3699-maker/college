/**
 * ============================================================
 * لوحة قسم البرمجة وتحليل نظم - Programming Department Dashboard
 * programming.js  v2.0.0
 * ============================================================
...
console.log('✅ programming.js v2.0.0 loaded');
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            return `عدد الطلاب: ${context.raw} طالب`;
                        }
                    }
                }
            },
...
// إضافة معلم جديد مع فتح وضع التعديل فوراً
function addTeacher() {
...
// إضافة موظف جديد مع فتح وضع التعديل فوراً
...
function saveDeptHead() {
    localStorage.setItem('deptHead_programming', JSON.stringify({
...
function loadDeptHead() {
    const saved = localStorage.getItem('deptHead_programming');
    if (saved) {
...
// ============================================================
function saveAll() {
    localStorage.setItem('deptTeachers_programming', JSON.stringify(teachers));
    localStorage.setItem('deptEmployees_programming', JSON.stringify(employees));
    saveDeptHead();
}

function loadAll() {
    const savedTeachers  = localStorage.getItem('deptTeachers_programming');
    const savedEmployees = localStorage.getItem('deptEmployees_programming');
