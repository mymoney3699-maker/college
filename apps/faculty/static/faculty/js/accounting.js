/**
 * ============================================================
 * لوحة قسم المحاسبة - Accounting Department Dashboard
 * accounting.js  v2.0.0
 * ============================================================
 */

console.log('✅ accounting.js v2.0.0 loaded');
...
function saveDeptHead() {
    localStorage.setItem('deptHead_accounting', JSON.stringify({
...
function loadDeptHead() {
    const saved = localStorage.getItem('deptHead_accounting');
    if (saved) {
...
function saveAll() {
    localStorage.setItem('deptTeachers_accounting', JSON.stringify(teachers));
    localStorage.setItem('deptEmployees_accounting', JSON.stringify(employees));
    saveDeptHead();
}

function loadAll() {
    const savedTeachers  = localStorage.getItem('deptTeachers_accounting');
    const savedEmployees = localStorage.getItem('deptEmployees_accounting');
